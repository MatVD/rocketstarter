...
export default function Templates() {
  const handleLaunchTemplate = (templateId: string) => {
    ...
    alert(`Launching strategy "${template?.title}" - Feature to implement`);
  };
    ...
    <div className="p-4 md:p-6">
        ...
        <div className="flex items-center space-x-3 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Choose a strategy template to accelerate your Web3 project
              development
            </p>
          </div>
        </div>
      ...
      >
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-6">
          Our team can build a custom strategy tailored to your specific Web3
          project needs. Contact us to discuss your project.
        </p>
        <motion.button
