                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    {editMode ? (
                      <input
                        type="text"
                        className="w-full px-4 py-3 bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 dark:text-white"
                        value={username}
                      ...
                      <div className="bg-gray-200 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg px-4 py-3 text-sm text-gray-600 dark:text-gray-400">
                        {user.username || (
